...
namespace FixItNow.Infrastructure.Migrations
{
    ...
    [Migration("20260605091019_FixBookingRequestTable")]
    partial class FixBookingRequestTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FixItNow.Domain.Models.BookingRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixItNow.Domain.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixItNow.Domain.Models.Tickets.TicketImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixItNow.Domain.Models.Review", b =>
                {
                    ...
                    b.HasOne("FixItNow.Domain.Models.Tickets.Ticket", "Ticket")
                        .WithOne("Review")
                        .HasForeignKey("FixItNow.Domain.Models.Review", "TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
